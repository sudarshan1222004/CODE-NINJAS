...
<style>
body {
    background: url('image/finalbg.png') ;
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Testify</span></div>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="usn" name="usn" placeholder="USN" class="form-control input-md" type="text">
...
<a href="#" data-toggle="modal" data-target="#login">Login as Admin</a></div>
<div class="col-md-4 box">
<a href="#" data-toggle="modal" data-target="#developers">About us</a>
</div>
<div class="col-md-4 box">
<a href="feedback.php" target="_blank">Feedback/Report an issue</a></div></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/cn.png" width=100 height=100 alt="CODE NINJAS" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">CODE NINJAS<br><br>Sudarshan-22cs163<br>Vishal-22cs184<br>Sharth-22cs140<br>Sujan-22cs164</a>
		</div></div>
		</p>
      </div>
...
<!--Modal for admin login-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
        <h4 class="modal-title"><span style="color:black;font-family:'typo' "><center>login as admin</center></span></h4>
      </div>
